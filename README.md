...
We provide the `sutadapter/start_server.sh` script for doing so.
In this case, the `-command` option should not be used in the _Learner_'s configuration file (it can ommitted or commented out using `#`).
